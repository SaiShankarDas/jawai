    ...
    <div id="hero" className="relative h-screen w-full overflow-hidden bg-stone-900">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 max-w-5xl mx-auto">
        <motion.span 
          ...
          className="text-jawai-sand font-medium tracking-[0.2em] uppercase mb-4 md:mb-6 drop-shadow-md text-sm md:text-base"
        >
        ...
        <motion.h1 
          ...
          className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-serif font-bold text-white mb-6 leading-tight drop-shadow-lg"
        >
          Experience the Real <br className="hidden md:block" /> Safari of Jawai
        </motion.h1>
        ...
        <motion.p 
          ...
          className="text-base md:text-xl text-white/95 max-w-2xl mb-8 md:mb-10 font-light drop-shadow-md px-2"
        >
