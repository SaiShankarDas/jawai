      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-2 flex flex-col items-center md:items-start">
            <h2 className="text-2xl font-serif font-bold text-white mb-4">SAFARI OF JAWAI</h2>
            ...
            <div className="flex gap-4">
              <a 
                href="https://www.instagram.com/safari.of.jawai/" 
                target="_blank" 
        ...
        <div className="border-t border-stone-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm">
          <p>&copy; {new Date().getFullYear()} Safari of Jawai. All rights reserved.</p>
