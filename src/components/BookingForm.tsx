    ...
    <Section id="booking" className="bg-jawai-green text-white relative overflow-hidden">
      ...
      <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center relative z-10">
        <div className="text-center lg:text-left">
          ...
          <div className="space-y-4 text-white/80 flex flex-col items-center lg:items-start">
            ...
            <div className="flex items-center gap-3">
              ...
              <span>bookings@safariofjawai.com</span>
            </div>
          </div>
        </div>

        <div className="bg-white text-stone-800 p-6 md:p-8 rounded-2xl shadow-2xl">
          {submitted ? (
